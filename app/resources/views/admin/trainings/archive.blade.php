...
@section('title', 'Archív tréningov')
...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.trainings.archive') }}" class="row g-2 align-items-end">
                <div class="col-md-8">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.trainings.archive') }}" class="btn btn-outline-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-striped mb-0 align-middle">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">Žiadne tréningy v archíve.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
