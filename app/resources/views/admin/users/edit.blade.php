        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.users.update', $user) }}" novalidate>
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox" value="1" id="is_trainer" name="is_trainer" @checked(old('is_trainer', $user->is_trainer))>
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" value="1" id="is_reception" name="is_reception" @checked(old('is_reception', $user->is_reception ?? false))>
                    ...
                    <div class="mb-3" id="creditsFieldWrapper">
                        ...
                        <input id="credits" type="number" min="0" name="credits" value="{{ old('credits', $user->credits ?? 0) }}"
